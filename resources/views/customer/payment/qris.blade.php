...
<div class="flex flex-col items-center justify-center min-h-screen bg-gray-50">
    <div class="bg-white shadow rounded-2xl p-6 w-full max-w-md">
        ...
        <div class="text-center mb-4">
            ...
            @else
                {{-- Fallback: Tombol ke halaman QRIS jika qr_string tidak tersedia --}}
        ...
        <a href="{{ route('carts.cartcustomer') }}" class="block text-center text-sm text-blue-500 mt-4 underline">Kembali ke Keranjang</a>
    </div>
</div>
            ...
            .then(data => {
                if (data.status === 'paid') {
                    document.getElementById('status-payment').innerHTML = `
                        ...
                        <div class="mt-2"><a href='{{ route('orders.history') }}' class="underline text-blue-600">Lihat Riwayat Pesanan</a></div>
                    `;
                    ...
                    document.getElementById('status-payment').innerHTML = `
                        ...
                        <div class="mt-2"><a href='{{ route('carts.cartcustomer') }}' class="underline text-blue-600">Kembali ke Keranjang</a></div>
                    `;
                    clearInterval(window.checkQRInterval);
                }
            }).catch(err => {
